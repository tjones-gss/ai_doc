---
title: 'log-viewer'
description: 'See multiple logs and analyze better'
...
> **TL;DR** — See multiple logs and analyze better

## Overview

`log-viewer` is part of the GSS InternalTools catalog. This page was generated from repository metadata and README content so the tool is discoverable in the AI Tools at GSS catalog and future RAG-backed GSS Catalog.
...
- **LaunchPad app:** [https://launchpad.globalshopsolutions.dev/apps/log-viewer](https://launchpad.globalshopsolutions.dev/apps/log-viewer)
- **Repo:** [https://github.com/GlobalShopSolutions-InternalTools/log-viewer](https://github.com/GlobalShopSolutions-InternalTools/log-viewer)
...
- **Repo last pushed:** 2026-07-07
- **Repo topics:** `launchpad`, `owner-gdeloscobos-at-gssmail-dot-com`, `starter`

## Owner & support

- **Owner:** [gdeloscobos@gssmail.com](mailto:gdeloscobos@gssmail.com)
- **Repo:** [https://github.com/GlobalShopSolutions-InternalTools/log-viewer](https://github.com/GlobalShopSolutions-InternalTools/log-viewer)
- **App page:** [log-viewer on LaunchPad](https://launchpad.globalshopsolutions.dev/apps/log-viewer)
