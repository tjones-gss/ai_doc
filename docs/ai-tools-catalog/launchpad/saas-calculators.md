...
description: 'A calculator to set up cloud accounts for customers, to set payment amounts based on selections'
...
> **TL;DR** — A calculator to set up cloud accounts for customers, to set payment amounts based on selections

## Overview

`saas-calculators` is part of the GSS InternalTools catalog. This page was generated from repository metadata and README content so the tool is discoverable in the AI Tools at GSS catalog and future RAG-backed GSS Catalog.

A calculator to set up cloud accounts for customers, to set payment amounts based on selections
...
- **LaunchPad app:** [https://launchpad.globalshopsolutions.dev/apps/saas-calculators](https://launchpad.globalshopsolutions.dev/apps/saas-calculators)
- **Repo:** [https://github.com/GlobalShopSolutions-InternalTools/saas-calculators](https://github.com/GlobalShopSolutions-InternalTools/saas-calculators)
...
- **Repo:** [https://github.com/GlobalShopSolutions-InternalTools/saas-calculators](https://github.com/GlobalShopSolutions-InternalTools/saas-calculators)
- **App page:** [saas-calculators on LaunchPad](https://launchpad.globalshopsolutions.dev/apps/saas-calculators)
