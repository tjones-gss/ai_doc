---
title: 'delta-t'
description: 'Performance and speed improvements'
sidebar_position: 69
...
> **TL;DR** — Performance and speed improvements

## Overview

`delta-t` is part of the GSS InternalTools catalog. This page was generated from repository metadata and README content so the tool is discoverable in the AI Tools at GSS catalog and future RAG-backed GSS Catalog.
...
- **LaunchPad app:** [https://launchpad.globalshopsolutions.dev/apps/delta-t](https://launchpad.globalshopsolutions.dev/apps/delta-t)
- **Repo:** [https://github.com/GlobalShopSolutions-InternalTools/delta-t](https://github.com/GlobalShopSolutions-InternalTools/delta-t)
...
- **Repo:** [https://github.com/GlobalShopSolutions-InternalTools/delta-t](https://github.com/GlobalShopSolutions-InternalTools/delta-t)
- **App page:** [delta-t on LaunchPad](https://launchpad.globalshopsolutions.dev/apps/delta-t)
