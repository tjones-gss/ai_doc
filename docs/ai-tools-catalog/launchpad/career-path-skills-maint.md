---
title: 'career-path-skills-maint'
description: 'Internal app created via Launchpad by asmith@gssmail.com'
sidebar_position: 63
last_updated: 2026-07-02
tags: [ai-tools, gss-internal, launchpad]
---

# career-path-skills-maint

> **TL;DR** — Internal app created via Launchpad by asmith@gssmail.com

## Overview

`career-path-skills-maint` is part of the GSS InternalTools catalog. This page was generated from repository metadata and README content so the tool is discoverable in the AI Tools at GSS catalog and future RAG-backed GSS Catalog.

Internal Career Path skills maintenance and review app (Launchpad).
...
- **LaunchPad app:** [https://launchpad.globalshopsolutions.dev/apps/career-path-skills-maint](https://launchpad.globalshopsolutions.dev/apps/career-path-skills-maint)
- **Repo:** [https://github.com/GlobalShopSolutions-InternalTools/career-path-skills-maint](https://github.com/GlobalShopSolutions-InternalTools/career-path-skills-maint)
...
- # Set DATABASE_HOST, DATABASE_PASSWORD, etc.
- npm install
...
- **Repo topics:** `launchpad`, `owner-asmith-at-gssmail-dot-com`, `starter`

## Owner & support

- **Owner:** [asmith@gssmail.com](mailto:asmith@gssmail.com)
- **Repo:** [https://github.com/GlobalShopSolutions-InternalTools/career-path-skills-maint](https://github.com/GlobalShopSolutions-InternalTools/career-path-skills-maint)
- **App page:** [career-path-skills-maint on LaunchPad](https://launchpad.globalshopsolutions.dev/apps/career-path-skills-maint)
