...
description: 'App for QA to manage Patch releases and view various information about patch manifests.'
sidebar_position: 94
...
> **TL;DR** — App for QA to manage Patch releases and view various information about patch manifests.

## Overview

`patch-maintenance` is part of the GSS InternalTools catalog. This page was generated from repository metadata and README content so the tool is discoverable in the AI Tools at GSS catalog and future RAG-backed GSS Catalog.

App for QA to manage Patch releases and view various information about patch manifests.
...
- **LaunchPad app:** [https://launchpad.globalshopsolutions.dev/apps/patch-maintenance](https://launchpad.globalshopsolutions.dev/apps/patch-maintenance)
- **Repo:** [https://github.com/GlobalShopSolutions-InternalTools/patch-maintenance](https://github.com/GlobalShopSolutions-InternalTools/patch-maintenance)
...
- **Repo topics:** `launchpad`, `owner-ksmith-at-gssmail-dot-com`, `starter`

## Owner & support

- **Owner:** [ksmith@gssmail.com](mailto:ksmith@gssmail.com)
- **Repo:** [https://github.com/GlobalShopSolutions-InternalTools/patch-maintenance](https://github.com/GlobalShopSolutions-InternalTools/patch-maintenance)
- **App page:** [patch-maintenance on LaunchPad](https://launchpad.globalshopsolutions.dev/apps/patch-maintenance)
