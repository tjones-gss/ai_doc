...
description: 'Test api for license reporting and artifacts. Streams appropriate version of worker version based on reported GS version.'
sidebar_position: 88
...
> **TL;DR** — Test api for license reporting and artifacts. Streams appropriate version of worker version based on reported GS version.

## Overview

`license-server` is part of the GSS InternalTools catalog. This page was generated from repository metadata and README content so the tool is discoverable in the AI Tools at GSS catalog and future RAG-backed GSS Catalog.

Test api for license reporting and artifacts. Streams appropriate version of worker version based on reported GS version.
...
- **LaunchPad app:** [https://launchpad.globalshopsolutions.dev/apps/license-server](https://launchpad.globalshopsolutions.dev/apps/license-server)
- **Repo:** [https://github.com/GlobalShopSolutions-InternalTools/license-server](https://github.com/GlobalShopSolutions-InternalTools/license-server)
...
- **Repo topics:** `launchpad`, `owner-jonschwartz-at-gssmail-dot-com`, `starter`

## Owner & support

- **Owner:** [jonschwartz@gssmail.com](mailto:jonschwartz@gssmail.com)
- **Repo:** [https://github.com/GlobalShopSolutions-InternalTools/license-server](https://github.com/GlobalShopSolutions-InternalTools/license-server)
- **App page:** [license-server on LaunchPad](https://launchpad.globalshopsolutions.dev/apps/license-server)
