...
description: "Lets AI agents search your Outlook email, Outlook calendar, Teams chat, SharePoint, and find meeting availability — all through your normal Microsoft 36..."
sidebar_position: 8
...
> **TL;DR** — Lets AI agents search your Outlook email, Outlook calendar, Teams chat, SharePoint, and find meeting availability — all through your normal Microsoft 365 sign-in. Reaches what's already in your inbox/calendar without you leaving an AI session.

## Overview

A connected MCP server that exposes your Microsoft 365 data (your own — it uses your auth, scoped to what you can see) to your AI agent. Your AI agent can:
...
- **Read M365 resources** — pull a specific doc the agent found.
...
- Pulling Teams chat context into a current AI agent task.

## When to use it

You're asking your AI agent something and the answer probably lives in your Microsoft 365 data. Examples:
...
Connected by default in the GSS AI tooling setup. First use prompts for Microsoft auth — sign in with your normal `@gssmail.com` account. After that, it just works.
...
Only the parts your AI agent needs to answer your question (a search result, a thread your agent opened). It does not bulk-export your inbox. Treat any AI tool as you'd treat an external service: don't ask it to read or summarize confidential customer/PII content unless cleared per data-handling rules.
